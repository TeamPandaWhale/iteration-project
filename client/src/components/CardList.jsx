...
//       <div className='pageturn-button-next' onClick={onNextClick} disabled={isNextDisabled}>
//         <svg
//           xmlns='http://www.w3.org/2000/svg'
//           width='30'
//           height='85'
...
const CardList = ({ onLike, onPreviousClick, onNextClick, isPreviousDisabled, isNextDisabled }) => {
  return (
    <div className='card-list-container'>
      <div
        className='pageturn-button-previous'
      ...
      <div className='card-list'>
        {useSelector((state) => state.app.games).map((game) => (
          <Card key={game.id} game={game} onLike={() => onLike(game.name)} />
        ))}
      </div>
